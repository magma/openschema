...
let package = Package(
    ...
    targets: [
        ...
        .target(
            ...
            resources : [
                .copy("ProtoFiles/bootstrapper.proto"),
                .copy("ProtoFiles/certifier.proto"),
                .copy("ProtoFiles/identity.proto"),
                .copy("ProtoFiles/metrics.proto"),
                .copy("ProtoFiles/metricsd.proto")
            ]
        ),
        .testTarget(
